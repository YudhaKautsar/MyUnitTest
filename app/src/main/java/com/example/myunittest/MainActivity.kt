...
class MainActivity : AppCompatActivity(), OnClickListener {
    ...
    private fun visible() {
        activityMainBinding.btnCalculateVolume.visibility = VISIBLE
        activityMainBinding.btnCalculateSurfaceArea.visibility = VISIBLE
        activityMainBinding.btnCalculateCircumference.visibility = VISIBLE
        activityMainBinding.btnSave.visibility = GONE
    }

    private fun gone() {
        activityMainBinding.btnCalculateVolume.visibility = GONE
        activityMainBinding.btnCalculateSurfaceArea.visibility = GONE
        activityMainBinding.btnCalculateCircumference.visibility = GONE
        activityMainBinding.btnSave.visibility = VISIBLE
    }
